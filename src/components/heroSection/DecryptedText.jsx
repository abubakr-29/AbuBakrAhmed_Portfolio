...
export default function DecryptedText({
  ...
  return (
    <motion.span
      ref={containerRef}
      className={`inline-block whitespace-pre-wrap font-special font-bold tracking-tighter sm:tracking-normal text-4xl md:text-6xl lg:text-7xl leading-tight text-white mb-4 text-center ${parentClassName}`}
      {...hoverProps}
      {...props}
    >
